...
const allCards = [
  { id: "fool", name: "The Fool", meaning: "New beginnings, innocence, spontaneity", color: "yellow" },
  { id: "magician", name: "The Magician", meaning: "Manifestation, power, inspired action", color: "green" },
  { id: "tower", name: "The Tower", meaning: "Sudden upheaval, chaos, revelation", color: "red" }
];
